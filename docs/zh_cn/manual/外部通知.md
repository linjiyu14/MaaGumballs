...
参照Qsmg的官方[文档地址](https://qmsg.zendee.cn/docs/)，将分配机器人**添加qq好友**，获取自己的**key**，然后将自己的qq加入列表，如下图所示：
![qmsg管理台设置](https://gitee.com/dealos/image-upload/raw/master/MaaGumballs/qmsgv3.png)
